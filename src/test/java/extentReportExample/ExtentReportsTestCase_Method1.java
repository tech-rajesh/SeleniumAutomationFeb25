...
public class ExtentReportsTestCase_Method1 {
	...
	public void startReport() {
		...
		// "/test-output/TCS_ExtentReport.html");
		String dateName_number = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		htmlReporter = new ExtentHtmlReporter("./test-output/TCS_ExtentReport"+dateName_number+".html");
		...
		htmlReporter.config().setDocumentTitle("TCS - Functional Automation/API Report");
		// Name of the report
